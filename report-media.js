import {doc,getDoc,setDoc,deleteDoc} from "https://www.gstatic.com/firebasejs/11.0.0/firebase-firestore.js";
...
function closed(layer,force=false){return !!(force||layer?.done||layer?.status==='service_finished'||layer?.status==='done'||layer?.status==='discarded')}
