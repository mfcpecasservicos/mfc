(function(){
  ...
  async function loadFirebaseCompat(){
    ...
    let app=window.firebase.apps.find(a=>a.name==='mfc-location-tools');if(!app)app=window.firebase.initializeApp(config,'mfc-location-tools');
